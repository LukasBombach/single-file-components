 ...
 * the tagname will be in group 1 in the results
 * the contantes will be in group 2
 * it will return a react component with the tagname
 * the react component will have children which will be the contents 
 * recursively resolved with this function
 * @param {*} source 
 */
function getReactFromHtml(source) {
  try {
    ...
    return React.createElement(tagName, {}, getReactFromHtml(innerHtml));
  } catch (err) {
    return source;
  }
}
