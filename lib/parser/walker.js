...
(() => {
  ...
  var HTMLParser = (parser = this.HTMLParser = function(html, handler) {
    var index,
      chars,
      match,
      stack = [],
  ...
  /* const html = `<div>a</div>b<div>c</div>d<div><div>e</div></div>`;
...
module.exports.ResigWalker = parser;
